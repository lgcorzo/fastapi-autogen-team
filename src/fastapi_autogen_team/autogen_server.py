...
def handle_response(response: Output) -> dict:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="An internal error occurred while processing the response.") from e
...
def generate_streaming_response(inp: Input, queue: Queue):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="An internal error occurred during streaming.") from e
...
def create_non_streaming_response(chat_results, model: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="An internal error occurred while creating the response.") from e
