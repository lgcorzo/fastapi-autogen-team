...
| Property | Type | Description |
| :--- | :--- | :--- |
| `Image` | `struct { image_url: ImageUrl }` | Field of Content |
| `Text` | `struct { text: String }` | Field of Content |
...
| Property | Type | Description |
| :--- | :--- | :--- |
| `String` | `tuple(String)` | Field of ContentType |
| `List` | `tuple(Vec<Content>)` | Field of ContentType |
