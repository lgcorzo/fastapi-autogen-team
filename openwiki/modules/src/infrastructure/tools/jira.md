...
| Property | Type | Description |
| :--- | :--- | :--- |
| `EnvVarMissing` | `(#[from], env::VarError)` | Field of JiraError |
| `RequestError` | `(#[from], reqwest::Error)` | Field of JiraError |
| `Other` | `(String)` | Field of JiraError |
