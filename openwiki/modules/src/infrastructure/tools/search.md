...
@startuml
    ...
    SearchError --> String : Association
...
| Property | Type | Description |
| :--- | :--- | :--- |
| `EnvVarMissing` | `(#[from], env::VarError)` | Field of SearchError |
| `RequestError` | `(#[from], reqwest::Error)` | Field of SearchError |
| `Other` | `(String)` | Field of SearchError |
