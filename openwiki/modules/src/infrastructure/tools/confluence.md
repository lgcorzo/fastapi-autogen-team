...
| Property | Type | Description |
| :--- | :--- | :--- |
| `EnvVarMissing` | `tuple(env::VarError)` | Field of ConfluenceError |
| `RequestError` | `tuple(reqwest::Error)` | Field of ConfluenceError |
| `Other` | `tuple(String)` | Field of ConfluenceError |
