...
| Property | Type | Description |
| :--- | :--- | :--- |
| `EnvVarMissing(#[from], env::VarError)` | `variant` | Field of R2RError |
| `RequestError(#[from], reqwest::Error)` | `variant` | Field of R2RError |
| `Other(String)` | `variant` | Field of R2RError |
