...
| Property | Type | Description |
| :--- | :--- | :--- |
| `EnvVarMissing` | `(#[from], env::VarError)` | Field of R2RError |
| `RequestError` | `(#[from], reqwest::Error)` | Field of R2RError |
| `Other` | `(String)` | Field of R2RError |
