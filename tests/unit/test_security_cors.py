...
def test_cors_empty_origins():
    ...
    response = client.options("/autogen/api/v1beta/models", headers={
...
def test_cors_specific_origins():
    ...
    response_good = client.options("/autogen/api/v1beta/models", headers={
    ...
    response_bad = client.options("/autogen/api/v1beta/models", headers={
        "Origin": "https://evil.com",
        "Access-Control-Request-Method": "GET"
    })
