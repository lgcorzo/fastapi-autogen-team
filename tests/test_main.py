...
def mock_app():
    ...
    with patch("fastapi_autogen_team.main.FastAPI") as MockFastAPI, \
        ...
        yield (mock_app, mock_scheduler, MockFastAPI, MockBackgroundScheduler, MockInstrumentApp,
               MockOTLPSpanExporter, MockBatchSpanProcessor, MockTracerProvider, MockPeriodicExportingMetricReader,
               MockOTLPMetricExporter, MockMeterProvider, MockSetMeterProvider, MockLoggingBasicConfig, MockTraceSetTracerProvider,
...
async def test_get_models(mock_app):
    ...
    (mock_app, mock_scheduler, MockFastAPI, MockBackgroundScheduler, MockInstrumentApp,
     MockOTLPSpanExporter, MockBatchSpanProcessor, MockTracerProvider, MockPeriodicExportingMetricReader,
     MockOTLPMetricExporter, MockMeterProvider, MockSetMeterProvider, MockLoggingBasicConfig, MockTraceSetTracerProvider,
     MockLoadDotenv, MockGetEnv) = mock_app
...
def test_heartbeat_and_log(mock_app):
    ...
    with patch("fastapi_autogen_team.main.logger.info") as mock_logger_info,\
